...
export default function ExitPopup() {
  ...
  useEffect(() => {
    // 1. DESKTOP LOGIC: Mouse leaving the screen
    ...
    // 2. MOBILE FALLBACK LOGIC: 12 Seconds Timer
    // Agar user laptop/mobile par 12 second guzaar le aur mouse leave trigger na hua ho
  ...
  return (
    ...
    >
      ...
      >
        ...
        <h2 className="heading-font text-4xl sm:text-5xl md:text-6xl tracking-tighter mb-3 md:mb-4 leading-[0.9] text-black">
        ...
        <div className="flex flex-col gap-3 md:gap-4">
          <div className="border-[3px] md:border-[4px] border-dashed border-black bg-white p-3 md:p-4 text-center heading-font text-2xl md:text-3xl tracking-widest text-black">
            SAUCY10
          </div>
          <button 
            onClick={() => setIsVisible(false)}
            className="bg-black text-[#ccff00] border-[3px] md:border-[4px] border-black px-6 md:px-8 py-3 md:py-4 font-bold text-lg md:text-xl uppercase hover:bg-white hover:text-black transition-colors shadow-[4px_4px_0px_0px_rgba(0,0,0,0.3)] md:shadow-[6px_6px_0px_0px_rgba(0,0,0,0.3)] cursor-pointer"
          >
            Apply Discount
          </button>
        </div>
